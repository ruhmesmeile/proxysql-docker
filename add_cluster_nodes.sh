...
do
	echo $i 
        ...
        mysql -h 127.0.0.1 -P6032 -uadmin -p$PROXYSQL_ADMIN_PASSWORD -e "INSERT INTO mysql_servers (hostgroup_id, hostname, port, max_replication_lag) VALUES (0, '$i', 3306, 20);"
 done
